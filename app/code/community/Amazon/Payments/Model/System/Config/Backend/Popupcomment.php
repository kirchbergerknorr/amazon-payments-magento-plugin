...
class Amazon_Payments_Model_System_Config_Backend_Popupcomment extends Mage_Core_Model_Config_Data
{
    ...
    public function getCommentText(Mage_Core_Model_Config_Element $element, $currentValue)
    {
        ...
        <li>' . str_replace($replace_cleanup, '', Mage::getUrl('amazon_payments/customer/authorize', array('_store' => $store_id, '_forced_secure' => true))) . '</li>
        <li>' . str_replace($replace_cleanup, '', Mage::getUrl('amazon_payments/checkout/authorize', array('_store' => $store_id, '_forced_secure' => true))) . '</li>
        </ul>
        </div>
